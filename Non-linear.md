...
- Linear (like a shopping list): 1 → 2 → 3 → 4
- Non-Linear (like a family tree): Parent → Children → Grandchildren (branching)

Non-linear means **data connects in multiple directions**, not just in a straight line.

---

## 📊 Compare All Non-Linear Structures

| Structure | Looks Like | Where Used | Speed |
|---|---|---|---|
| **Tree** | Upside-down tree 🌳 | File systems, folders | Fast |
| **Binary Tree** | Tree with max 2 children | Sorting, parsing | Fast |
| **BST** | Sorted binary tree | Search, databases | Very Fast |
| **Heap** | Pyramid 🔺 | Priority queues | Very Fast |
| **Graph** | Network 🕸️ | Maps, social networks | Variable |
...
| **Balanced** | Heights differ by 1 max | ✓ |
...
# 🚀 COMPLETE DJANGO PROJECT: Tree-Based File Manager
